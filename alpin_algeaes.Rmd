...
```{r loads_robitools, warning=FALSE}
...
```{r loads_tidyverse, warning=FALSE}
...
```{r loads_matrixStats, warning=FALSE}
...
```{r loads_gridExtra, warning=FALSE}
...
```{r loads_robustreg, warning=FALSE}
...
*Chlorophyta* DNA represents a small part of the of the extracted environmental DNA.
...
```{r biplot_rda, fig.height=4, fig.width=8, warning=FALSE}
...
```{r anova_plot, fig.width=6, fig.height=4}
par(mfrow = c(1, 2))
...
The heterogeneous distribution of the MOTUs is studied only for MOTUs that where 
taxonomically identified at the species or genus levels.
