...
```{r}
write.csv2(euka03.eukaryota@reads,file   = "cleaned_datasets/euka03.cleanned.reads.csv")
write.csv2(euka03.eukaryota@motus,file   = "cleaned_datasets/euka03.cleanned.motus.csv")
write.csv2(euka03.eukaryota@samples,file = "cleaned_datasets/euka03.cleanned.samples.csv")
```
